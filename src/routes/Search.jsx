...
export default function Search(props) {
    ...
    // Debounce filters and search query to reduce API calls
    ...
    // Effect to reset products and fetch new ones when filters or search query change
    useEffect(() => {
    ...
    }, [debouncedFilters, debouncedSearchQuery, regionid, regionObj]);
    ...
    }, [regionid, debouncedFilters, debouncedSearchQuery, processProducts]);
    ...
    return (
        <>
            ...
            <section className="bg-dark text-white text-center py-5">
                <Container>
                    <h1 className="display-4 fw-bold mb-4">Search Products</h1>
                    <p className="lead mb-4">Find exactly what you're looking for</p>
            ...
            <Container className="py-5">
                <h2 className="mb-4 text-center">
                    {filters.category.name === "" ? "All" : filters.category.name}
                    {(debouncedSearchQuery || keyword) && ` / "${debouncedSearchQuery || keyword}"`}
                </h2>
                    ...
                    <Col md={9}>
                        ...
                        {!loading && products.length === 0 && !error && (
                            <Alert variant="info" className="text-center my-4">
                                ...
                                <p>
                                    {(debouncedSearchQuery || keyword)
                                        ? `No results for "${debouncedSearchQuery || keyword}". Try adjusting your search or filters.`
